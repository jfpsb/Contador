...
public class XmlContagemProdutoStrategy implements IXmlStrategy {
    @Override
    public void write(String path, Serializer serializer, EntidadeMySQL entidadeMySQL) throws Exception {
        EntidadeMySQLContagemProduto entidadeMySQLContagem = (EntidadeMySQLContagemProduto) entidadeMySQL;
    ...
    public EntidadeMySQL read(Serializer serializer, File arquivo) throws Exception {
        return serializer.read(EntidadeMySQLContagemProduto.class, arquivo);
    }
}
