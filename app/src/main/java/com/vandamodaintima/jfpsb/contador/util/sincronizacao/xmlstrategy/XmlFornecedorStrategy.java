...
public class XmlFornecedorStrategy implements IXmlStrategy {
    @Override
    public void write(String path, Serializer serializer, EntidadeMySQL entidadeMySQL) throws Exception {
        EntidadeMySQLFornecedor entidadeMySQLContagem = (EntidadeMySQLFornecedor) entidadeMySQL;
    ...
    public EntidadeMySQL read(Serializer serializer, File arquivo) throws Exception {
        return serializer.read(EntidadeMySQLFornecedor.class, arquivo);
    }
}
